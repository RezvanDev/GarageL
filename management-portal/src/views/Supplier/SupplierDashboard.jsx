...
export const SupplierDashboard = () => {
    ...
    return (
        <div className="fade-in">
            <h2 style={{ marginBottom: '32px', fontWeight: 800 }}>Кабинет Поставщика / 供应商后台</h2>
            
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
                <div className="glass-card" style={{ padding: '30px' }}>
                    <Zap size={32} color="var(--accent-blue)" style={{ marginBottom: '16px' }} />
                    <h3 style={{ marginBottom: '12px' }}>Быстрый старт / 快速入门</h3>
                    <p style={{ color: 'var(--text-dim)', lineHeight: 1.6 }}>
                        ...
                        <br />
                        在“客户订单”板块，您可以查看当前的配件需求请求。提供您的价格和条件以获取订单。
                    </p>
                </div>
                ...
                {!isTelegramConnected ? (
                    <div className="glass-card" style={{ 
                        ...
                        <p style={{ color: 'var(--text-dim)', lineHeight: 1.6, marginBottom: '20px' }}>
                            ...
                            <br />
                            绑定 Telegram，以便即时获取新需求和订单状态更新的通知。
                        </p>
                    ...
                    <div className="glass-card" style={{ padding: '30px', border: '1px solid rgba(16, 185, 129, 0.2)' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', color: '#10b981' }}>
                            <Bell size={24} />
                            <h3 style={{ margin: 0 }}>Уведомления активны / 通知已启用</h3>
                        </div>
                        <p style={{ color: 'var(--text-dim)', lineHeight: 1.6, marginTop: '16px' }}>
                            ...
                            <br />
                            您已成功绑定 Telegram。所有关于新请求的通知都将发送到机器人中。
                        </p>
                    </div>
                )}
            </div>
